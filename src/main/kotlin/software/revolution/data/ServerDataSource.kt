...
open class ServerDataSource(server: MinecraftServer, fileName: String) : DataSource {
    private val file = server.getSavePath(WorldSavePath.ROOT).resolve("config/herobrine").resolve("$fileName.herobrine")
